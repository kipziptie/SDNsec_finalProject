...
INFLUX_SINK_UDP_IP = "127.0.0.1"
INFLUX_SINK_UDP_PORT = 8094

FIREWALL_SWITCH_DP_ID = 1
MONITOR_FREQUENCE_IN_SECONDS = 5
...
class CoreController(app_manager.RyuApp):
    ...
    def _port_stats_reply_handler(self, ev):
        ...
        for stat in sorted(body, key=attrgetter('port_no')):
            ...
            sock.sendto(msg.encode(), (INFLUX_SINK_UDP_IP, INFLUX_SINK_UDP_PORT))
...
class Firewall(object):
    ...
    def _set_rule(self, cookie, rest, waiters, vlan_id):
        ...
        if(priority > LOG_FLOW_PRIORITY and priority < ACL_FLOW_PRIORITY_MAX and len(actions)>0):
            actions.append({'type': 'OUTPUT', 'port': '6'})
